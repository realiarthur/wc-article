...
В целом технология кажется перспективной а ее использование уже сейчас вполне может себя оправдать на небольших проектах. Но в текущем состоянии я бы не взял ее на большой проект, над которым работает несколько человек. 
...
[Полифилы,](https://github.com/webcomponents/polyfills/tree/master/packages/webcomponentsjs)
[Полифил для builtin elements,](https://www.npmjs.com/package/@ungap/custom-elements-builtin)
[Роутер,](https://vaadin.com/router)
[Коннектор redux,](https://www.npmjs.com/package/lite-redux) 
[Компонент формы,](https://www.npmjs.com/package/lite-form)
[Vaadin Components,](https://vaadin.com/components)
[Набор интересных проектов на lit-html](https://github.com/web-padawan/awesome-lit-html)
