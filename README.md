...
Этот функционал не имеет отношения к теме статьи, но стоит поговорить о том, во что его обернуть. Забегая вперед скажу, что прежде чем сделать рабочий вариант я попробовал 3 упаковки: стандарнтый веб-компонент, расширение нативного тега ```<form>``` и компонент высшего порядка. И это повод для небольшой истории...
...
В общем все работало отлично, но... 
Прежде чем рассказать почему я откался от Shadow DOM, еще пару слов о нем.
