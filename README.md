...
Всем привет! Меня зовут Артур, я работаю frontend-разработчиком в Exness. Не так давно мы решили перевести один из наших проектов на веб-компоненты. Хочу рассказать о том, с какими проблемами пришлось столкнуться, и о том, как многие концепции, к которым мы привыкли при работе с фреймворками, легко перекладываются на веб-компоненты. 
