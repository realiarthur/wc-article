...
Всем привет! Меня зовут Артур, я работаю frontend-разработчиком в Exness. Не так давно мы решили перевести один из наших проектов на веб-компоненты. Хочу рассказать об этом опыте, о том, с какими проблемами пришлось столкнуться, их решениях, и о том, как многие концепции, к которым мы привыкли при работе с фреймворками, легко перекладываются на веб-компоненты. 
 
Предполагается, что у читателя имеется базовое представление о технологии, но хотелось и без него дать возможность понять, что с веб-компонентами можно вполне удобно работать и организовывать архитектуру проекта.
