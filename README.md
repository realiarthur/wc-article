...
Изолированные кастомные компоненты, поддерживаемые браузером из коробки, и возможность расширять встроенные html-элементы уже несколько лет звучит как одно из возможных направлений развития frontend-разработки. Но при выборе технологий для реальных проектов всегда стоит вопрос: "Будущее уже настало?".
