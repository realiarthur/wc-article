...
```
Вместе с Shadow DOM я потерял проводника всплытия события blur для полей ввода. Я использовал его внутри HOC для полей ввода, чтобы мне не приходилось пробрасывать его из компонента вручную. Но я не растерялся, подписался на него на стадии погружения, и это сработало.
